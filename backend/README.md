...
## Project Structure
    ...
    ├── weatherfigma_dev_22686  # Django project configurations
...
1. Clone this repo and `cd weatherfigma_dev_22686`
...
2. Clone this repo and `cd weatherfigma_dev_22686`
